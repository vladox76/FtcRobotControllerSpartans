...
public class TeleOpCompletoConfig {
    ...
    public void init(HardwareMap ahwMap, Telemetry telemetry) {
        ...
        derecho(atrasDer , enfrenteDer , hex_0 , motor_1);
        ...
        usarUsingEncoder(enfrenteDer, enfrenteIzq, atrasDer, atrasIzq , hex_0 , motor_1);
